				...
				for ($i = 1; $i <= 4; $i++) {
					...
					if($i==1){
						...
						if($devis[0][ "type_contrat"] == "presta"){	$row_data["D"]=='706240'; }
							...
							if($refinanceur['refinanceur']=='BMF'){
							...
							}elseif($refinanceur['refinanceur']=='CLEOFI' || $refinanceur['refinanceur']=='FRANFINANCE MANDAT'){
								...
								if($infos_commande['date_evolution'] > $item['facture.date_periode_debut']){
									...
									if($refinanceur['refinanceur']=='FRANFINANCE MANDAT'){
										$row_data["D"]="467800";
									}else{
										$row_data["D"]="467500";
									}
						...
						$cleofi = false;
						if($refinanceur['refinanceur']=='CLEOFI' || $refinanceur['refinanceur']=='FRANFINANCE MANDAT'){
