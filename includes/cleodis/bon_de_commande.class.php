	...
	*/
	public function insert($infos,&$s,$files=NULL,&$cadre_refreshed=NULL,$nolog=false){
		...
		foreach($infos_bon_de_commande_ligne as $key=>$item){
			...
			$bon_de_commande_ligne["caracteristique"]=$commande_ligne["caracteristique"];
...
class bon_de_commande_solo extends bon_de_commande_cleodis {
	function __construct() {
		parent::__construct();
		$this->table = "bon_de_commande";
...
class bon_de_commande_go_abonnement extends bon_de_commande_cleodis { };