...
if (!class_exists('TCPDF', false)) {
    if (file_exists(__ATF_PATH__.'libs/PDF_ImageAlpha.class.php')) {
        include_once __ATF_PATH__.'libs/PDF_ImageAlpha.class.php';
        /**
         * Class fpdi_bridge
         */
        class fpdi_bridge extends PDF_ImageAlpha {
            // empty body
        }        
    } else {
        /**
