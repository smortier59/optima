 ...
 * parameter order.
 * 
 * @version   $Id: finance.class.php,v 1.1 2006/06/02 15:18:42 ygautheron Exp $
...
class Financial
{
	...
	*/
	 ...
	 *
	 */
	function YIELD_($settlement, $maturity, $rate, $pr, $redemption, $frequency, $basis = FINANCIAL_BASIS_MSRB_30_360)
	{
		if (!$this->_is_valid_basis($basis)) return null;
