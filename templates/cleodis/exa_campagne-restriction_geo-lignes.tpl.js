...
{if ATF::_r('id_exa_campagne') }
	{$exa_campagne=ATF::_r('id_exa_campagne')}
{/if}
...
[new Ext.tree.TreePanel({
	...
	rootVisible: false,
	frame: true,
	loader:new Ext.tree.TreeLoader({ dataUrl: 'societe,getTreePanel.ajax,type=restriction_geo&id_societe={$id_societe}{if $exa_campagne}&exa_campagne={$exa_campagne}{/if}' }),
	...
	id: 'restriction_geo',
	value: {if ATF::_r('id_exa_campagne') } Ext.getCmp('restriction_geo').value; {else} '' {/if}
}]