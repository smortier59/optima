...
{/if}
{if ATF::$codename == "cleodis" || ATF::$codename == "cleodisbe" || ATF::$codename == "assets" || ATF::$codename=="itrenting" || ATF::$codename=="solo" || ATF::$codename=="arrow" || ATF::$codename == "go_abonnement"}
{
