...
{if ATF::$usr->privilege('prolongation', 'insert')}
    ATF.renderer.cmdAction = function(table, field) {
        return function(filetype, meta, record, rowIndex, colIndex, store) {
            ...
            html += '<p>';
            html += '<a href="javascript:;"  onclick="Ext.getCmp(\'mywindow' + id + '\').show();">'; html += '<img src="{ATF::$staticserver}images/icones/pdf.png" />'; html += ATF.usr.trans('creerCourrierType', 'commande'); html += '</a>'; html += '</p>';
