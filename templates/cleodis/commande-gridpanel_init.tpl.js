{ strip } { * Ajout du champ nécessaire pour ce renderer * } { util::push($fieldsKeys, "commande.etat") }
/* Pour les dates ! */
{ util::push($fieldsKeys, "commande.date_debut") } { util::push($fieldsKeys, "commande.date_evolution") } { util::push($fieldsKeys, "commande.retour_contrat") } { util::push($fieldsKeys, "commande.retour_prel") } { util::push($fieldsKeys, "commande.retour_pv") }

{ util::push($fieldsKeys, "commande.date_demande_resiliation") } { util::push($fieldsKeys, "commande.date_prevision_restitution") } { util::push($fieldsKeys, "commande.date_restitution_effective") } { util::push($fieldsKeys, "commande.date_demande_reprise_broker") }
...
/* Pour les Factures */
{ util::push($fieldsKeys, "factureAllow") } { util::push($fieldsKeys, "id_affaireCrypt") }
/* Pour les Ventes */
{ util::push($fieldsKeys, "vente") }
/* Pour les Fichiers */
{ util::push($fieldsKeys, "envoiContratEtBilanExists") } { util::push($fieldsKeys, "envoiContratSsBilanExists") } { util::push($fieldsKeys, "envoiAvenantExists") } { util::push($fieldsKeys, "contratTransfertExists") } { util::push($fieldsKeys, "ctSigneExists") } { util::push($fieldsKeys, "CourrierRestitutionExists") } { util::push($fieldsKeys, "allowBDCCreate") } { util::push($fieldsKeys, "allowAllBDCCreate") } { if ATF::$codename == "cleodis" } { util::push($fieldsKeys, "ctSGEFExists") } {
    /if} { if ATF::$codename == "cleodisbe" } { util::push($fieldsKeys, "ctlettreBelfiusExists") } { /
    if
}
                                                ...
                                                return function(filetype, meta, record, rowIndex, colIndex, store) {
                                                        ...
                                                        if (!Ext.getCmp('myForm' + id)) { 
                                                            var formPanel = new Ext.FormPanel({
                                                                            ...
                                                                            store: new Ext.data.ArrayStore({
                                                                                ...
                                                                                data: [
                                                                                    ...
                                                                                    ['lettreSGEF', 'Contrat vente SGEF'] {
                                                                                        /if} { if ATF::$codename == "cleodisbe" } ['lettreBelfius', 'Contrat vente Belfius'] {
                                                                                            /if}
                                                                                ...
                                                                                listeners: {
                                                                                    select: function(field) {
                                                                                        if (field.value == "lettreSGEF") {
                                                                                            ...
                                                                                            Ext.getCmp("date_signature" + id).setVisible(false);
                                                                                            Ext.getCmp("equipement" + id).setVisible(false);
                                                                                            ATF.ajax("commande,getDateResti.ajax", "id_commande=" + id, {
                                                                ...
                                                                html += '<p>'; html += '<a href="javascript:;"  onclick="Ext.getCmp(\'mywindow' + id + '\').show();">'; html += '<img src="{ATF::$staticserver}images/icones/pdf.png" />'; html += ATF.usr.trans('creerCourrierType', 'commande'); html += '</a>'; html += '</p>';
