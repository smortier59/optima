...
[new Ext.tree.TreePanel({
	...
	rootVisible: false,
	frame: true,
	loader:new Ext.tree.TreeLoader({ dataUrl: 'societe,getTreePanel.ajax,type=restriction_services&id_societe={$id_societe}{if $exa_directeur}&exa_directeur={$exa_directeur}{/if}' }),
	...
	listeners: {
		'checkchange': function(node,checked){			
			...
			Ext.getCmp('restriction_services').setValue(this.getChecked('id').join('-'));		}
	}
}),{
	xtype:'hidden',
	name: 'restriction_services',
	id: 'restriction_services',
	value: ''
}]