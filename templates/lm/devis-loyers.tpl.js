...
{/if}
{
	...
	,listeners :{
		change:function(f,n,o){
			var prix=parseFloat(n)+parseFloat(Ext.ComponentMgr.get('devis[frais_de_gestion_unique]').getValue())+parseFloat(Ext.ComponentMgr.get('devis[assurance_unique]').getValue());
