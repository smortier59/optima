		...
		columns: [
		     {
				...
				header: 'Prix HT',
				width:20,
				dataIndex: '{$current_class->table}__dot__prix_prestation',
				editor: new Ext.form.TextField({
					value:0
				})
			},{
				header: 'Recurrence',
				width:20,
				dataIndex: '{$current_class->table}__dot__recurrence',
				editor: {include file="generic-gridpanel-combo.tpl.js" key=recurrence function=null}
			},{
				header: 'Departement',
				width:20,
