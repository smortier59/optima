...
[new Ext.tree.TreePanel({
	...
	rootVisible: false,
	frame: true,
	loader:new Ext.tree.TreeLoader({ dataUrl: 'societe,getParc.ajax,id_societe={$id_societe}{if $id_affaire}&id_affaire={$id_affaire}{/if}' }),
	...
	listeners: {
		'checkchange': function(node,checked){
			...
			Ext.getCmp('AR').setValue(this.getChecked('id').join(','));
		}
	}
}),{
	xtype:'hidden',
