...
function pickcolor(cssclass, csselement, csscookie, cssform, link, adjX, adjY, div_temoin) {
	...
	function selectmouse(e) {
			...
			//Check to see if mouse is in the selection area
				if (0 <= dotX && dotX <= 150 && 0 <= dotY && dotY <= 150) {
					...
					document.getElementById(div_temoin).style.backgroundColor = document.getElementById("cmColorContainer").style.backgroundColor;
					
					changecss(cssclass,csselement,hex,"hex",csscookie,cssform);

					document.onmousemove = dragSVColourMod;
