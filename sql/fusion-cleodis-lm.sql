...
ALTER TABLE `produit`
	...
	ADD `tva_prix_achat` decimal(3,2) NULL DEFAULT 1.20 after `ean` ,
	ADD `id_pack_produit` smallint(5) unsigned NULL after `tva_prix_achat` ,
	...
	ADD `min` int(11)   NOT NULL  DEFAULT 0 after `declencheur_mep` ,
	ADD `max` int(11)   NOT NULL DEFAULT 0  after `min` ,
	ADD `defaut` int(11)   NOT NULL DEFAULT 0  after `max` ,
