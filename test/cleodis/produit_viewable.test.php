<?
class produit_viewable_test extends ATF_PHPUnit_Framework_TestCase {
	...
	*/
	...
	public function test_constructeur(){
		$this->_produit_viewable = new produit_viewable();	
	}

	/** @test Test du constructeur produit.  */
	public function test_autocomplete(){
		ATF::_s('preselected_produit_viewable',array(array("id_produit_viewable"=>1)));
