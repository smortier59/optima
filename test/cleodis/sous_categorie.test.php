...
class sous_categorie_test extends ATF_PHPUnit_Framework_TestCase {
	...
	*/
	...
	function test_autocomplete(){
		...
		$autocomplete=ATF::sous_categorie_cleodis()->autocomplete($infos);


		$this->assertEquals(ATF::sous_categorie_cleodis()->cryptId(25),$autocomplete[0]["0"],"autocompleteAvecAdresse ne renvoie pas le bon id crypté");
