<?
class produit_ram_test extends ATF_PHPUnit_Framework_TestCase {
	...
	*/
	...
	public function test_constructeur(){
		$this->_produit_ram = new produit_ram();	
	}

	/** @test Test du constructeur produit.  */
	public function test_autocomplete(){
		ATF::_s('preselected_produit_ram',array(array("id_produit_ram"=>1)));
