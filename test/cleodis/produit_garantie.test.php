<?
class produit_garantie_test extends ATF_PHPUnit_Framework_TestCase {
	...
	*/
	...
	public function test_constructeur(){
		$this->_produit_garantie = new produit_garantie();	
	}

	/** @test Test du constructeur produit.  */
	public function test_autocomplete(){
		ATF::_s('preselected_produit_garantie',array(array("id_produit_garantie"=>1)));
