<?
class produit_puissance_test extends ATF_PHPUnit_Framework_TestCase {
	...
	*/
	...
	public function test_constructeur(){
		$this->_produit_puissance = new produit_puissance();	
	}

	/** @test Test du constructeur produit.  */
	public function test_autocomplete(){
		ATF::_s('preselected_produit_puissance',array(array("id_produit_puissance"=>1)));
