<?
class produit_lecteur_test extends ATF_PHPUnit_Framework_TestCase {
	...
	*/
	...
	public function test_constructeur(){
		$this->_produit_lecteur = new produit_lecteur();	
	}

	/** @test Test du constructeur produit.  */
	public function test_autocomplete(){
		ATF::_s('preselected_produit_lecteur',array(array("id_produit_lecteur"=>1)));
