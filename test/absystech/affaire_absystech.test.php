...
class affaire_absystech_test extends ATF_PHPUnit_Framework_TestCase {
	...
	function testUpdate_termes(){
		...
		$this->assertEquals(array(0=>array("msg"=>"Modification de l'enregistrement 'Tu_devis' effectuée avec succès.","title"=>"Succès !","timer"=>"",'type' => 'success')),ATF::$msg->getNotices(),"1 La notice de modification fonctionne bien");
		$affaire=$this->obj->select($this->id_affaire);
