...
class hotline_test extends ATF_PHPUnit_Framework_TestCase {
	...
	*/
	...
	protected function setUp() {
        ...
        $ts -= 90*$unJour; // 60 jours de moins

        $sql = 'DELETE FROM `hotline` WHERE hotline.date < "'.(date('Y-m-d 00:00:00', $ts)).'"';
        ATF::db()->sql2array($sql);

       /*ATF::hotline()->q->reset()->where("hotline.date",,"AND",false,"<");
    ...
    public function test_stats(){
        ...
        $id_soc1=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 1'));
        $id_soc2=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 2'));
        $id_soc3=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 3'));
        $id_soc4=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 4'));
        $id_soc5=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 5'));
        $id_soc6=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 6'));
        $id_soc7=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 7'));
        $id_soc8=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 8'));
        $id_soc9=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 9'));
        $id_soc10=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 10'));
        $id_soc11=ATF::societe()->i(array('id_commercial'=> 1 , 'societe'=>'soc lol 11'));
    ...
    public function test_statCleodis(){
        ...
        $result = array(
            ...
            "Facture" => array( 1 => array("semestre" => "2015-01-01 au 2015-06-30", "duree" => 19296 , "dureeH" => 321.60),
                                2 => array("semestre" => "2015-07-01 au 2015-12-31", "duree" => 12015 , "dureeH" => 200.25)),
    ...
    public function test_ListeHotline(){
        ...
        $id_societe=ATF::societe()->i(array('societe'=>'soc lol', "id_commercial"=>1));
